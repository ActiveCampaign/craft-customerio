...
var CustomerioForm = {
  ...
  checkCaptcha: function(e) {
    ...
    let captchaId = window.CustomerioForm.formTarget.querySelector('.g-recaptcha').getAttribute('data-recaptcha-id');
  ...
  submitForm: function(token) {
    ...
    xhr.onload = function() {
      if (xhr.status == 200) {
        ...
        successMsg.innerHTML = '<strong>Thanks for signing up!</strong> <br>Check your inbox for a link to confirm your subscription.';
